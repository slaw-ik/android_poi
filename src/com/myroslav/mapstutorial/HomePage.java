...
public class HomePage extends ActionBarActivity {
	...
	protected void downloadCoords() {
        if(isConnected()){
            ...
            new HttpAsyncTask().execute("http://poi.herokuapp.com/pointers.json");
        }
        else{
        	Toast.makeText(getBaseContext(), "You are NOT conncted to the Internet!", Toast.LENGTH_LONG).show();
        }
